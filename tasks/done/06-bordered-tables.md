...
- `cmd/gdrive-cli/search.go` — search results table (Name, Type, Modified, URL)
- `cmd/gdrive-cli/fetch.go` — fetch result table
- `cmd/gdrive-cli/auth_login.go` — auth status table
